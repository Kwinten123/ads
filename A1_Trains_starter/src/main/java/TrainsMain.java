...
/**
 * This is the main starting application.
 *
 * When you have finished your assignment, the output of the application should match the output
 * that's in th assigment description.
 *
 */
